...
local LIBRARY_URL = "https://cp4x.github.io/irisworks-iris/libraryLS.lua"

-- Paste the raw URL of the already-hosted The Tower module here.
local THE_TOWER_MODULE_URL = "https://cp4x.github.io/irisworks-iris/towermodLS.lua"

-- Murder Mystery 2 production module.
local MM2_MODULE_URL = "https://cp4x.github.io/irisworks-iris/mm2modLS.lua"
...
local APOCALYPSE_RISING_2_MODULE_URL =
    "https://cp4x.github.io/irisworks-iris/ar2modLS.lua"

-- Flick production module.
-- Host the generated flickmod.lua at this URL.
local FLICK_MODULE_URL = "https://cp4x.github.io/irisworks-iris/flickmodLS.lua"

-- Generic Vitality component interface used when the current game is unsupported.
local FALLBACK_MODULE_URL = "https://cp4x.github.io/irisworks-iris/fallbackmod.lua"

-- Remote data-only manifest. This is decoded as JSON and is never executed.
local STATUS_MANIFEST_URL = "https://cp4x.github.io/irisworks-iris/statusLS.json"
